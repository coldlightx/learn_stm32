...
void MyCAN_init()
{
    ...
    can_filter_config.CAN_FilterMode = CAN_FilterMode_IdMask;
    can_filter_config.CAN_FilterScale = CAN_FilterScale_32bit;

    uint32_t id_reg_value = 0x12345600 << 3 | 0x04;
    can_filter_config.CAN_FilterIdHigh = id_reg_value >> 16;
    can_filter_config.CAN_FilterIdLow = id_reg_value;

    uint32_t mask_reg_value = 0xFFFFFF00 << 3 | 0x06;
    can_filter_config.CAN_FilterMaskIdHigh = mask_reg_value >> 16;
    can_filter_config.CAN_FilterMaskIdLow = mask_reg_value;
