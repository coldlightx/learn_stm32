...
void MyCAN_init()
{
    ...
    can_filter_config.CAN_FilterScale          = CAN_FilterScale_16bit;
    can_filter_config.CAN_FilterIdHigh         = 0x234 << 5;
    can_filter_config.CAN_FilterIdLow          = 0x345 << 5;
    can_filter_config.CAN_FilterMaskIdHigh     = 0x567 << 5;
    can_filter_config.CAN_FilterMaskIdLow      = 0;
    ...
    can_filter_config.CAN_FilterNumber         = 1;
    can_filter_config.CAN_FilterMode           = CAN_FilterMode_IdList;
    can_filter_config.CAN_FilterScale          = CAN_FilterScale_16bit;
    can_filter_config.CAN_FilterIdHigh         = 0x678 << 5;
    can_filter_config.CAN_FilterIdLow          = 0;
    can_filter_config.CAN_FilterMaskIdHigh     = 0;
    can_filter_config.CAN_FilterMaskIdLow      = 0;
    can_filter_config.CAN_FilterFIFOAssignment = CAN_Filter_FIFO0;
    can_filter_config.CAN_FilterActivation     = ENABLE;
    CAN_FilterInit(&can_filter_config);
