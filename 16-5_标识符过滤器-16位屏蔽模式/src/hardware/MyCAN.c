...
void MyCAN_init()
{
    ...
    can_filter_config.CAN_FilterIdHigh     = 0x200 << 5;
    can_filter_config.CAN_FilterMaskIdHigh = 0x700 << 5 | 0x18;

    can_filter_config.CAN_FilterIdLow     = 0x320 << 5;
    can_filter_config.CAN_FilterMaskIdLow = 0x7F0 << 5 | 0x18;
